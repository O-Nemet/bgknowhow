...
<p>
    ...
    <br><br>
    Every comp features a link listing the common enablers, when to commit to it, how to play it (some even featuring an example run video), as well as possible addons to your board.
    <br><br>
