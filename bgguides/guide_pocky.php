...
<div class="guide">
    ...
    <p>
        A large cleave in front can take out a lot of minions at once, or more reliably snipe the opponents own high priority minions before they can attack or have an impact. Similarly, certain deathrattles are important to have gone off first, <a href="https://bgknowhow.com/bgstrategy/minion/?id=226">Blaster</a> to clear an opponent's divine shields, or a Spawn or <a href="https://bgknowhow.com/bgstrategy/minion/?id=136">Goldrinn</a> to buff as much of your board as possible. Another example of a minion that you would want to attack earlier is something like <a href="https://bgknowhow.com/bgstrategy/minion/?id=53">Deflect-o-Bot</a> (or formerly <a href="https://bgknowhow.com/bgstrategy/minion/?id=112">Holy Mecherel</a> RIP, leaving this lol), so it can lose its divine shield and get a potential reset before accidentally getting sniped later in your order. This is also why you typically position the reset right behind it.
    </p>
    <div class="comp_wrapper" style="width: 87%;">
        <?php
