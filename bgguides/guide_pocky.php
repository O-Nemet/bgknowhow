...
<div class="guide">
    ...
    <p>
        <br>
        <strong>Tempo</strong> heroes are heroes like <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=78">Yogg</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=32">Kael'thas</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=14">Deryl</a>, or <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=33">Mukla</a>. Simply put, they buff the stats on your minions which means all else being equal, your minions will typically be stronger than your opponents.
    </p>
    ...
    <p>
        <strong>Consistency</strong> heroes are heroes like <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=10">Hooktusk</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=46">Nozdormu</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=39">Malygos</a>, and <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=20">Elise</a>. These heroes have ways of rerolling minions or taverns, or discovering minions, so that when you are offered unideal options, you have a chance to try to get better minions, or hit triples thus reducing the swing impacts of RNG, and more consistently having a solid board.
    </p>
    <div class="comp_wrapper" style="width: 51%">
    ...
    <p>
        <strong>Value</strong> heroes are heroes that allow you to most efficiently use your gold. Value heroes are heroes like <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=6">Rafaam</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=38">Maiev</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=41">Millhouse</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=76">Xyrella</a>, and <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=78">Yogg</a>. They can all acquire minions at a reduced cost that allows them to often have more minions on board, or in hand, which opens up avenues for greedy leveling, or an increased chance at triples.
    </p>
    ...
    <p>
        <strong>Greed</strong> heroes are heroes like <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=1">A. F. Kay</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=3">Alexstrasza</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=55">Reno Jackson</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=9">Captain Eudora</a>, and <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=62">Skycap'n Kragg</a>. These heroes effectively play without a hero power for a period, and in return get a power spike later on in the game. While they play without a hero power they are typically punished by taking high damage, but the power spike(s) allows them the opportunity to swing the game back into their favor.
    </p>
    <div class="comp_wrapper" style="width: 65%">
    ...
    <p>
        <strong>Combat</strong> heroes are heroes like <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=69">Lich King</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=2">Al'Akir</a>, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=7">Bru'kan</a>, etc. They used to be bad. However, most combat hero powers have moved to costing 0 gold, which means that they can be viable, or even strong with the right comps to take advantage of their hero powers.
    </p>
    ...
    <p>
        ...
        <br><br>
        For <strong>tempo</strong> hero powers, your strength is your board strength, which is particularly impactful in the early game. A <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=33">Mukla</a> or <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=78">Yogg</a> on turns 3-7 are likely simply going to be stronger than most other heroes simply by having more stats on their minions. We will get into tempo a little more with understanding game state, but essentially since you will typically have a strong tempo early game, you are afforded the ability to occasionally play greedy, whether it's by leveling faster as <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=78">Yogg</a>, or perhaps holding for an extra turn to dance more, as <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=14">Deryl</a>. Many of these heroes fall off later as the stats buffs become less relevant as other players start to scale with
        ...
        <br><br>
        A brief note on armor. Armor does matter, but for the vast majority of heroes it is meant to be a win rate equalizer. Some heroes like <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=43">Mr. Bigglesworth</a> or <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=35">Lich Baz'hial</a> have much more to consider with their armor values as it can impact how their hero plays. Usually it should not be a major factor in your hero choice though.
        <br><br>
    ...
    <p>
        ...
        <br><br>
        Murlocs provide access to abundant venom. Mechs dominate divine shield access. Quilboar benefit from those shields with <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=56">Gemsplitter</a> and <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=84">Groundshaker</a>. Naga may prefer to be paired with Quilboar for access to cheap spells, or with cleaves to take advantage of their type neutral utility. All those shields might not prove as impactful when Dragons are in.
        <br><br>
    ...
    <br>
    <p>
        The first point is commonly seen in the aforementioned <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=6">Rafaam</a> curve:
    </p>
    ...
    <p>
        ...
        <br><br>
        If your opponents are wasting 20 gold in a game, and you're perfectly efficient, you're getting a boost of two <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=62">Kragg</a> hero powers in a single game! That's an insane advantage, almost sure to make up for any bad RNG. Now of course playing perfectly efficiently isn't realistic, but you would be surprised how often the margin between you and your opponents could be even more than 20 gold. A million gold isn't cool. You know what's cool? A billion gold.
    </p>
    <h4 data-movie="Mel Brooks">“Money does buy happiness. And I'm healthy already.”</h4>
    <p>
        This is pretty straightforward and essentially what was discussed around greedy heroes, and when to deviate from the curve. It's simply knowing when you are wealthy and healthy (#rhymes) enough to take a hit while being greedy, or when you are poor and need to be a little more frugal with your health. If you are willing to play with your MMR a little, practicing with <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=50">Patchwerk</a> and <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/hero/?id=35">Lich Baz'hial</a> can give you a good feel for managing health, as they both utilize it as a resource more than any other hero.
    </p>
    ...
    <p>
        A large cleave in front can take out a lot of minions at once, or more reliably snipe the opponents own high priority minions before they can attack or have an impact. Similarly, certain deathrattles are important to have gone off first, <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=226">Blaster</a> to clear an opponent's divine shields, or a Spawn or <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=136">Goldrinn</a> to buff as much of your board as possible. Another example of a minion that you would want to attack earlier is something like <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=53">Deflect-o-Bot</a> (or formerly <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=112">Holy Mecherel</a> RIP, leaving this lol), so it can lose its divine shield and get a potential reset before accidentally getting sniped later in your order. This is also why you typically position the reset
        right behind it.
    </p>
    <div class="comp_wrapper" style="width: 87%;">
        <?php
    ...
    <h4>Taunts</h4>
    <p>
        Taunts are severely underrated by lower level players. Taunts are one of the best ways to manipulate the outcomes of battles in ways that favor you because it's the most you can do to control how your opponents' minions attack. They serve a lot of purposes, mostly related to what we discussed above. A taunt soaking attacks means that the minions that you want to have attack priority will more likely get to attack, and your general attack order will be preserved. It also helps keep your other minions alive. The last value is that they serve as cleave protection. We've all been devastated by that cleave that just kills 3 minions in the middle of your order, or snipes your most important minion. Putting a taunt at the far left or usually right (so it stays alive rather than attacking), and a low value minion next to it can protect from a strong potential cleave. You'll often see a <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=272">Risen Rider</a>, <a
                class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=73">Annoy-o-Module</a>, or Divine Shield taunt put into unrelated builds to simply provide a two attack taunt for protection. Another benefit with some of these minions is that, unbuffed, they can be used to play around cards like <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=140">Nadina</a> or <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=12">Scallywag</a>.
    </p>
    <div class="comp_wrapper">
        <?php
