...
<div class="guide">
    ...
    <p>
        <br>
        <strong>Tempo</strong> heroes are heroes like <a class="hoverimage" href="/bgstrategy/hero/?id=78">Yogg</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=32">Kael'thas</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=14">Deryl</a>, or <a class="hoverimage" href="/bgstrategy/hero/?id=33">Mukla</a>. Simply put, they buff the stats on your minions which means all else being equal, your minions will typically be stronger than your opponents.
    </p>
    <div class="comp_wrapper" style="width: 51%">
        <a href="/bgstrategy/hero/?id=78"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_039_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=32"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_066_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=14"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_042_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=33"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_038_render_80.webp"></a>
    </div>
    <p>
        <strong>Consistency</strong> heroes are heroes like <a class="hoverimage" href="/bgstrategy/hero/?id=10">Hooktusk</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=46">Nozdormu</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=39">Malygos</a>, and <a class="hoverimage" href="/bgstrategy/hero/?id=20">Elise</a>. These heroes have ways of rerolling minions or taverns, or discovering minions, so that when you are offered unideal options, you have a chance to try to get better minions, or hit triples thus reducing the swing impacts of RNG, and more consistently having a solid board.
    </p>
    <div class="comp_wrapper" style="width: 51%">
        <a href="/bgstrategy/hero/?id=10"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_075_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=46"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_063_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=39"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_052_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=20"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_047_render_80.webp"></a>
    </div>
    <p>
        <strong>Value</strong> heroes are heroes that allow you to most efficiently use your gold. Value heroes are heroes like <a class="hoverimage" href="/bgstrategy/hero/?id=6">Rafaam</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=38">Maiev</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=41">Millhouse</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=76">Xyrella</a>, and <a class="hoverimage" href="/bgstrategy/hero/?id=78">Yogg</a>. They can all acquire minions at a reduced cost that allows them to often have more minions on board, or in hand, which opens up avenues for greedy leveling, or an increased chance at triples.
    </p>
    <div class="comp_wrapper" style="width: 65%">
        <a href="/bgstrategy/hero/?id=6"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_053_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=38"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_068_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=41"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_054_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=76"><img src="<?= PICTURE_LOCAL ?>heropowers/BG20_HERO_101p_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=78"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_039_render_80.webp"></a>
    </div>
    <p>
        <strong>Greed</strong> heroes are heroes like <a class="hoverimage" href="/bgstrategy/hero/?id=1">A. F. Kay</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=3">Alexstrasza</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=55">Reno Jackson</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=9">Captain Eudora</a>, and <a class="hoverimage" href="/bgstrategy/hero/?id=62">Skycap'n Kragg</a>. These heroes effectively play without a hero power for a period, and in return get a power spike later on in the game. While they play without a hero power they are typically punished by taking high damage, but the power spike(s) allows them the opportunity to swing the game back into their favor.
    </p>
    <div class="comp_wrapper" style="width: 65%">
        <a href="/bgstrategy/hero/?id=1"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_044_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=3"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_064_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=55"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_046_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=9"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_074_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=62"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_076_render_80.webp"></a>
    </div>
    <p>
        <strong>Combat</strong> heroes are heroes like <a class="hoverimage" href="/bgstrategy/hero/?id=69">Lich King</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=2">Al'Akir</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=7">Bru'kan</a>, etc. They used to be bad. However, most combat hero powers have moved to costing 0 gold, which means that they can be viable, or even strong with the right comps to take advantage of their hero powers.
    </p>
    <div class="comp_wrapper" style="width: 41%">
        <a href="/bgstrategy/hero/?id=69"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_024_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=2"><img src="<?= PICTURE_LOCAL ?>heropowers/TB_BaconShop_HP_086_render_80.webp"></a>
        <a href="/bgstrategy/hero/?id=7"><img src="<?= PICTURE_LOCAL ?>heropowers/BG22_HERO_001p_render_80.webp"></a>
    </div>
    ...
    <p>
        ...
        <br><br>
        For <strong>tempo</strong> hero powers, your strength is your board strength, which is particularly impactful in the early game. A <a class="hoverimage" href="/bgstrategy/hero/?id=33">Mukla</a> or <a class="hoverimage" href="/bgstrategy/hero/?id=78">Yogg</a> on turns 3-7 are likely simply going to be stronger than most other heroes simply by having more stats on their minions. We will get into tempo a little more with understanding game state, but essentially since you will typically have a strong tempo early game, you are afforded the ability to occasionally play greedy, whether it's by leveling faster as <a class="hoverimage" href="/bgstrategy/hero/?id=78">Yogg</a>, or perhaps holding for an extra turn to dance more, as <a class="hoverimage" href="/bgstrategy/hero/?id=14">Deryl</a>. Many of these heroes fall off later as the stats buffs become less relevant as other players start to scale with
        proper scaling engines, so pressing your advantage early to gain further
        ...
        <br><br>
        <strong>Consistency</strong> hero powers see a few different impacts on their play. For one, similar to tempo heroes, they'll often have strong boards early game by virtue of having better minions. <a class="hoverimage" href="/bgstrategy/hero/?id=46">Nozdormu</a> is a great example of this. On turn 1 instead of picking the best of 3 minions, you get to pick the best of 6 minions. So instead of having a top 33% minion, you instead have a top 17% minion. This applies throughout the game, so you'll be able to have a better than average board. While slightly stronger minions don't quite give you the same relative tempo early, the extra consistency more importantly increases the likelihood you will hit triples, which makes it more conducive to pick up pairs when you're playing these heroes. Since you can have a relatively strong board by consistently getting good minions, oftentimes you'll be afforded the opportunity to hold onto pairs and level aggressively to
        triple into higher
        tier minions that can either give you a direction, or give you a strong power spike.
        <br><br>
        <strong>Value</strong> hero powers can get minions for cheaper, which means the main thing is to consider how to best utilize the extra resources it affords you. The simplest example of this are alternative curves like the "Rafaam or Warrior curves" (discussed below). These curves typically provide the benefit of being able to pick up pairs and additional minions, while later allowing you to use your extra gold to level quickly. Even more than the consistency heroes, you can triple into higher tier minions. <a class="hoverimage" href="/bgstrategy/hero/?id=38">Maiev</a> plays similar to <a class="hoverimage" href="/bgstrategy/hero/?id=6">Rafaam</a> except on a delay, but you can choose what you pick up, meaning you can prioritize pairs. Many heroes with 2 gold hero powers like <a class="hoverimage" href="/bgstrategy/hero/?id=76">Xyrella</a>, <a class="hoverimage" href="/bgstrategy/hero/?id=57">Scabbs</a>
        and <a class="hoverimage" href="/bgstrategy/hero/?id=78">Yogg</a>,
        ...
        <br><br>
        A brief note on armor. Armor does matter, but for the vast majority of heroes it is meant to be a win rate equalizer. Some heroes like <a class="hoverimage" href="/bgstrategy/hero/?id=43">Mr. Bigglesworth</a> or <a class="hoverimage" href="/bgstrategy/hero/?id=35">Lich Baz'hial</a> have much more to consider with their armor values as it can impact how their hero plays. Usually it should not be a major factor in your hero choice though.
        <br><br>
    ...
    <p>
        A brief example could be a <a class="hoverimage" href="/bgstrategy/hero/?id=38">Maiev</a> game in a lobby with Pirates, Mechs, Dragons, Quilboar, and Murlocs. <a class="hoverimage" href="/bgstrategy/hero/?id=38">Maiev</a> is strong at lining up early triples, especially into 6 before other heroes are able to. Dragons, Quilboar, and Murlocs can be slow to scale up, meaning an early <a class="hoverimage" href="/bgstrategy/minion/?id=131">Eliza</a> has a strong window to tempo out those comps. Pirate Exodia likes Quilboar in as a way to play around <a class="hoverimage" href="/bgstrategy/minion/?id=144">Zapp</a>. Mechs provide an alternative course in <a class="hoverimage" href="/bgstrategy/minion/?id=142">Omega Buster</a> as a comp that can also make use of a <a class="hoverimage" href="/bgstrategy/minion/?id=256">Titus</a>, as well as providing high tempo
        1 drops in <a class="hoverimage" href="/bgstrategy/minion/?id=6">Micro Mummy</a> and <a class="hoverimage" href="/bgstrategy/minion/?id=7">Pupbot</a>. Picking up early <a class="hoverimage" href="/bgstrategy/minion/?id=12">Scallywag</a>s, can play into this plan, and we can have contingencies if our plan doesn't come to fruition. Having a blurry painting of this before the game starts will help your game.
        <br><br>
    ...
    <p>
        ...
        <br><br>
        Tempo in a general sense is buying minions to optimize your chances of winning the next fight. Typically, this revolves around buying the minions with the best stats possible. Sometimes this is naked stats, but sometimes it's based on what's currently on your board. <a class="hoverimage" href="/bgstrategy/minion/?id=28">Murloc Warleader</a> can be a naked 3/3 or could effectively be adding 6 attack to 3 other murlocs already on your board. <a class="hoverimage" href="/bgstrategy/minion/?id=89">Menagerie Jug</a> can range from a 3/3 on its own, or it can be as strong as a 9/9 in total stats with a full buff.
    </p>
    <div class="comp_wrapper">
        <?php
        $board   = ['Warleader', 'Jug', 'Goldrinn', 'Mama Bear', 'Charlga', 'Kaly'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        ?>
    </div>
    <p>
        When you want or need to win fights, you should be playing for tempo. Oftentimes playing for tempo means that you'll naturally start taking advantage of tribal synergies, which begins what we call our direction. If your board is made up of 5 pirates early on, you will start looking for minions that benefit pirates, as you move to late-game. As you get later on in the game, if you have a direction, you'll be looking for 'keystone' cards that fit your direction. <a class="hoverimage" href="/bgstrategy/minion/?id=136">Goldrinn</a> or <a class="hoverimage" href="/bgstrategy/minion/?id=117">Mama Bear</a> for Beasts, <a class="hoverimage" href="/bgstrategy/minion/?id=130">Charlga</a> for Quilboar, <a class="hoverimage" href="/bgstrategy/minion/?id=138">Kalecgos, Arcane Aspect</a> for Dragons etc. Neutral cards like <a class="hoverimage" href="/bgstrategy/minion/?id=109">Brann</a>,
        <a class="hoverimage" href="/bgstrategy/minion/?id=256">Titus</a>, or <a class="hoverimage" href="/bgstrategy/minion/?id=242">Tea Master Theotar</a> can also advise your direction. If you don't have a direction, then it's important to play for tempo so that you can get to Tier 5 and 6 where most of the 'keystone' cards reside. This allows you to pick one of them up and then have a direction for your late game build. There is a balance to deciding what is an acceptable direction depending on the trajectory of a lobby, because different cards scale at different speeds. Scaling engines like <a class="hoverimage" href="/bgstrategy/minion/?id=138">Kaly</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=130">Charlga</a>, or <a class="hoverimage" href="/bgstrategy/minion/?id=206">Athissa</a> take time to build up. Exodia style comps scale exponentially with each additional
        piece of the puzzle picked up.
    </p>
    <div class="comp_wrapper">
        <?php
        $board   = ['Brann', 'Titus', 'Theo', 'Kaly', 'Charlga', 'Athissa'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        ?>
    </div>
    ...
    <br>
    <p>
        The first point is commonly seen in the aforementioned <a class="hoverimage" href="/bgstrategy/hero/?id=6">Rafaam</a> curve:
    </p>
    ...
    <p>
        ...
        <br><br>
        If your opponents are wasting 20 gold in a game, and you're perfectly efficient, you're getting a boost of two <a class="hoverimage" href="/bgstrategy/hero/?id=62">Kragg</a> hero powers in a single game! That's an insane advantage, almost sure to make up for any bad RNG. Now of course playing perfectly efficiently isn't realistic, but you would be surprised how often the margin between you and your opponents could be even more than 20 gold. A million gold isn't cool. You know what's cool? A billion gold.
    </p>
    <h4 data-movie="Mel Brooks">“Money does buy happiness. And I'm healthy already.”</h4>
    <p>
        This is pretty straightforward and essentially what was discussed around greedy heroes, and when to deviate from the curve. It's simply knowing when you are wealthy and healthy (#rhymes) enough to take a hit while being greedy, or when you are poor and need to be a little more frugal with your health. If you are willing to play with your MMR a little, practicing with <a class="hoverimage" href="/bgstrategy/hero/?id=50">Patchwerk</a> and <a class="hoverimage" href="/bgstrategy/hero/?id=35">Lich Baz'hial</a> can give you a good feel for managing health, as they both utilize it as a resource more than any other hero.
    </p>
    ...
    <p>
        ...
        <br><br>
        Knowing their comp is also vital to shop purchasing decisions and positioning. If someone has a deathrattle comp, you may more specifically look for a <a class="hoverimage" href="/bgstrategy/minion/?id=144">Zapp</a> to snipe their <a class="hoverimage" href="/bgstrategy/minion/?id=256">Titus</a>. If they're mechs on tier 4 you might put a bumper in front to break a potential divine shield on their taunt. If they look to have multiple shields, consider a <a class="hoverimage" href="/bgstrategy/minion/?id=226">Blaster</a>. If they are likely to have extremely high-statted minions, look for <a class="hoverimage" href="/bgstrategy/minion/?id=208">Leeroy</a> and venomous minions.
    </p>
    ...
    <p>
        Positioning can have a huge impact on combat outcomes. To use a stark example, imagine putting a <a class="hoverimage" href="/bgstrategy/minion/?id=256">Titus</a> in the left-most position and a <a class="hoverimage" href="/bgstrategy/minion/?id=136">Goldrinn</a> in the right-most position. In most situations that can turn an easy win into a guaranteed loss.
        <br><br>
    ...
    <h4>Priority</h4>
    <p>
        As an even more general rule, you want minions that you want to attack first to attack first. Mind-blowing, right? As we just went over, usually this is higher attack minions, but there are also any other number of reasons why we'd want other minions to attack first, usually because that minion has an effect on attacking (or on death). <a class="hoverimage" href="/bgstrategy/minion/?id=144">Zapp</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=60">Macaw</a>, and Cleave, Overkill, and Windfury minions all have additional value when they're attacking, but not when they're attacked. Part of the reason attacking first can be so important is if a <a class="hoverimage" href="/bgstrategy/minion/?id=144">Zapp</a> attacks first it can kill a <a class="hoverimage" href="/bgstrategy/minion/?id=256">Titus</a> or <a class="hoverimage" href="/bgstrategy/minion/?id=67">Juggler</a>
        before they can have any impact on a fight, if a <a class="hoverimage" href="/bgstrategy/minion/?id=60">Macaw</a> attacks first it can trigger free deathrattles before you have a chance to kill anything on their board.
    </p>
    ...
    <p>
        A large cleave in front can take out a lot of minions at once, or more reliably snipe the opponents own high priority minions before they can attack or have an impact. Similarly, certain deathrattles are important to have gone off first, <a class="hoverimage" href="/bgstrategy/minion/?id=226">Blaster</a> to clear an opponent's divine shields, or a Spawn or <a class="hoverimage" href="/bgstrategy/minion/?id=136">Goldrinn</a> to buff as much of your board as possible. Another example of a minion that you would want to attack earlier is something like <a class="hoverimage" href="/bgstrategy/minion/?id=53">Deflect-o-Bot</a> (or formerly <a class="hoverimage" href="/bgstrategy/minion/?id=112">Holy Mecherel</a> RIP, leaving this lol), so it can lose its divine shield and get a potential reset before accidentally getting sniped later in your order. This is also why you typically position the reset
        right behind it.
    </p>
    <div class="comp_wrapper" style="width: 87%;">
        <?php
    ...
    <p>
        Another concept of priority is minions you want to die later in combat. For obvious reasons you typically want to put these minions further right on your board to delay their attacks as much as possible. Examples of this are minions like <a class="hoverimage" href="/bgstrategy/minion/?id=256">Titus</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=117">Mama Bear</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=56">Gemsplitter</a> and other minions like Avenge units that have an effect while they're alive. Other minions that you might want to die later are things like <a class="hoverimage" href="/bgstrategy/minion/?id=114">Kangor's</a>, or <a class="hoverimage" href="/bgstrategy/minion/?id=61">Rat Pack</a>, so they can have as many summons as possible. Besides, positioning these minions to delay their attacks, there's one more way you can help these minions stay
        alive, which brings us to our next topic.
    </p>
    <h4>Taunts</h4>
    <p>
        Taunts are severely underrated by lower level players. Taunts are one of the best ways to manipulate the outcomes of battles in ways that favor you because it's the most you can do to control how your opponents' minions attack. They serve a lot of purposes, mostly related to what we discussed above. A taunt soaking attacks means that the minions that you want to have attack priority will more likely get to attack, and your general attack order will be preserved. It also helps keep your other minions alive. The last value is that they serve as cleave protection. We've all been devastated by that cleave that just kills 3 minions in the middle of your order, or snipes your most important minion. Putting a taunt at the far left or usually right (so it stays alive rather than attacking), and a low value minion next to it can protect from a strong potential cleave. You'll often see a <a class="hoverimage" href="/bgstrategy/minion/?id=272">Risen Rider</a>, <a
                class="hoverimage" href="/bgstrategy/minion/?id=73">Annoy-o-Module</a>, or Divine Shield taunt put into unrelated builds to simply provide a two attack taunt for protection. Another benefit with some of these minions is that, unbuffed, they can be used to play around cards like <a class="hoverimage" href="/bgstrategy/minion/?id=140">Nadina</a> or <a class="hoverimage" href="/bgstrategy/minion/?id=12">Scallywag</a>.
    </p>
    <div class="comp_wrapper">
        <?php
        $board   = ['Risen Rider', 'Module', 'Nadina', 'Scallywag', 'Titus', 'Zapp'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        ?>
    </div>
    <p>
        Last bit on positioning is just to reiterate and stress the importance of checking your opponents before combat. If they have 5 or 6 dragons you might want to play around <a class="hoverimage" href="/bgstrategy/minion/?id=140">Nadina</a>. If they're Beasts or Mechs you're more likely going to want to make sure you have cleave protection. If they're running <a class="hoverimage" href="/bgstrategy/minion/?id=256">Titus</a>, focus on trying to get <a class="hoverimage" href="/bgstrategy/minion/?id=144">Zapp</a> for a turn.
    </p>
