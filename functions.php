...
{
    return "These different compositions are meant to display proven setups to strive for, for the very end game (top 4 and above). In general one of the seven slots will be the 'flex' spot, used to cycle new minions during the tavern rounds. Therefore, your actual board will rarely be as perfect as these listed here. Of course as many minions as possible should be tripled and buffed with Reborn, Venomous, Divine Shield or Taunt.<br><br>Also primary support units like <a class='hoverimage' href='/bgstrategy/minion/?id=109'>Brann</a> and <a class='hoverimage' href='/bgstrategy/minion/?id=121'>Nomi</a> will usually be tossed for the very last fights, but are sometimes displayed here when being integral to the setup. If one of your units is lacking, it is also often beneficial to replace it with a <a class='hoverimage' href='/bgstrategy/minion/?id=208'>Leeroy</a> or a <a class='hoverimage' href='/bgstrategy/minion/?id=399'>Relentless Mur'ghoul</a>, before a deciding fight. Tier 7 minions are usually ignored for these comps, as <a class='hoverimage' href='/bgstrategy/anomaly/?id=8'>Secrets of Norgannon</a> only has a ~10% chance to be active.";
}
