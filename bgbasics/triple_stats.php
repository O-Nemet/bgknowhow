...
<div class="triple_stats">
    ...
    <p>
        Unaltered stats will result in a golden minion with its base stats. The golden version of <a class="hoverimage" href="/bgstrategy/minion/?id=14">Sellemental</a> (2/2) will have base stats of (4/4).
        <br><br>
    ...
    <p>
        In this example we have two buffed <a class="hoverimage" href="/bgstrategy/minion/?id=4">Icky Imp</a>s.
    ...
    <p>
        In this example we have two <a class="hoverimage" href="/bgstrategy/minion/?id=219">Tavern Tipper</a>s with a (-1/-1) debuff each. The resulting (-2/-2) would lead to the golden version (4/4) being reduced to a (2/2). But triples will never be reduced below base stats, resulting in a (4/4) golden minion.
        <br><br>
    ...
    <p>
        In this example we have two <a class="hoverimage" href="/bgstrategy/minion/?id=273">Rot Hide Gnoll</a>s with (+1/-3) (de-)buffs each, or (+2/-6) in total. Base stats of the golden version are (2/8).
        <br><br>
    ...
    <p>
        When we have three buffed minions, all buffs will simply be added. Examples of ways to buff minions in shop are <a class="hoverimage" href="/bgstrategy/minion/?id=121">Nomi</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=79">Dazzling Lightspawn</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=259">Felemental</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=237">Legion Overseer</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=227">Uther</a> or <a class="hoverimage" href="/bgstrategy/hero/?id=75">Vol'jin</a>. Additionally, you can get buffed minions from
        <a class="hoverimage" href="/bgstrategy/hero/?id=43">Mr. Bigglesworth</a>'s hero power.
        <br><br>
        As example for a scenario with three buffed minions we have three <a class="hoverimage" href="/bgstrategy/minion/?id=48">Bristleback Brute</a>s.
    ...
    <p>
        Auras and effects, like the attack buff from <a class="hoverimage" href="/bgstrategy/minion/?id=275">Nerubian Deathswarmer</a> or the +1/+1 effect from <a class="hoverimage" href="/bgstrategy/minion/?id=274">Eternal Knight</a>, will not be added together, but reapplied to the golden version (with golden Eternal Knight having a +2/+2 effect).
        <br><br>
        As the example we have three <a class="hoverimage" href="/bgstrategy/minion/?id=6">Micro Mummy</a>s.
