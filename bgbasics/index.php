...
<div>
    ...
    <p>
        As a defensive measure to protect your valuable creatures providing in-combat buffs (e.g. <a class="hoverimage" href="/bgstrategy/minion/?id=117">Mama Bear</a>) you can play minions with taunt or buff any of your minions via <a class="hoverimage" href="/bgstrategy/minion/?id=221">Sparring Partner</a> or <a class="hoverimage" href="/bgstrategy/minion/?id=250">Vigilant Stoneborn</a>. A basic strategy is to position a big taunt minion to the right side of your board, so that it attacks as late as possible and will block most of your opponents minions.
        <br><br>
        Another thing to keep in mind with taunt minions occurs when facing minions with cleave (e.g. <a class="hoverimage" href="/bgstrategy/minion/?id=327">Blade Collector</a>).
    </p>
    ...
    <p>
        ...
        shield (primarily via <a class="hoverimage" href="/bgstrategy/minion/?id=203">Glowscale</a>
        or <a class="hoverimage" href="/bgstrategy/minion/?id=73">Annoy-o-Module</a>).
        <br><br>
        ...
        minion is a <a class="hoverimage" href="/bgstrategy/minion/?id=208">Leeroy</a>, as he will
        kill any minion in one hit, shield or no shield. But even a small taunt minion like a <a class="hoverimage" href="/bgstrategy/minion/?id=272">Risen Rider</a> can be played as a blocker to waste your shield. If your opponent is featuring several shielded minions instead of just one huge one you should consider picking up a <a class="hoverimage" href="/bgstrategy/minion/?id=266">Blaster</a> and putting it in first position.
    </p>
    ...
    <p>
        A minion with Deathrattle will trigger an action upon its own death, usually spawning one or more token minions (token minions are 1-star minions not buyable from the shop). The number of spawns is limited by the currently remaining board space (e.g. <a class="hoverimage" href="/bgstrategy/minion/?id=62">Replicating Menace</a> will try to spawn 3 Microbot tokens, but if there are already 6 minions on the board only 1 Microbot will be created).
        <br><br>
        An example of a Deathrattle effect not spawning a minion is <a class="hoverimage" href="/bgstrategy/minion/?id=35">Selfless Hero</a> which will gift a Divine Shield upon death instead.
        <br><br>
        Deathrattle triggers before Reborn. Please check out this <a href="/bgstrategy/?show=minions&ability=deathrattle">list of all Deathrattle minions</a> to know your options.
    </p>
    ...
    <p>
        ...
        <br><br>
        Reborn triggers after Deathrattle. Please check out this <a href="/bgstrategy/?show=minions&ability=reborn">list of all Reborn minions</a> to know your options.
    </p>
    ...
    <p>
        ...
        two minions, namely <a class="hoverimage" href="/bgstrategy/minion/?id=327">Blade Collector</a>
        and <a class="hoverimage" href="/bgstrategy/minion/?id=133">Foe Reaper 4000</a>. There is
        also <a class="hoverimage" href="/bgstrategy/minion/?id=224">Wildfire Elemental</a> (will
    ...
    <p>
        ...
        <br><br>
        Please check out this <a href="/bgstrategy/?show=minions&ability=venomous">list of all Venomous minions</a> to know your options.
    </p>
    ...
    <p>
        ...
        <br><br>
        Please check out this <a href="/bgstrategy/?show=minions&ability=avenge">list of all Avenge minions</a> to know your options.
    </p>
    ...
    <p>
        Minions with this ability will trigger an effect when played from your hand. Many Battlecry effects will buff the minions on your board with permanent stats (e.g. <a class="hoverimage" href="/bgstrategy/minion/?id=89">Menagerie Jug</a>) or permanent abilites (e.g. Taunt by <a class="hoverimage" href="/bgstrategy/minion/?id=221">Sparring Partner</a>).
        <br><br>
        A key minion to utilize battlecries as a winning strategy is the neutral <a class="hoverimage" href="/bgstrategy/minion/?id=109">Brann Bronzebeard</a> available in all games. Also <a class="hoverimage" href="/bgstrategy/minion/?id=319">Rylak Metalhead</a> can trigger the battlecries from minions on your board during the combat phase (those buffs will vanish after combat, though).
        <br><br>
        Please check out this <a href="/bgstrategy/?show=minions&ability=battlecry">list of all Battlecry minions</a> to know your options.
    </p>
    ...
    <p>
        ...
        <br><br>
        Some minions add cards to your hand during combat (e.g. <a class="hoverimage" href="/bgstrategy/minion/?id=248">Bristlemane Scrapsmith</a>) or can access the cards in your hand (e.g. <a class="hoverimage" href="/bgstrategy/minion/?id=332">Bassgill</a>).
        <br><br>
    ...
    <p>
        Unless explicitly stated that an effect is permant (like on <a class="hoverimage" href="/bgstrategy/minion/?id=50">Budding Greenthumb</a>) buffs which happen during the combat phase won't carry over. This includes all "at the beginning of combat" effects.
        <br><br>
        On the other hand, buffs that happen during the tavern/buy phase (from something like <a class="hoverimage" href="/bgstrategy/minion/?id=351">The Boogie Monster</a>) or "at the end of your turn" (e.g <a class="hoverimage" href="/bgstrategy/minion/?id=351">Famished Felbat</a>) will persist, unless specified otherwise.
    </p>
    ...
    <p>
        ...
        randomly paired with one of the eliminated players. These eliminated players, referred to as ghosts or 'deadguys' (their ingame name will show as "Kel'Thuzad"), will bring their board lineup from the time of their death to the fight, but will not activate hero powers (even passive ones like from <a class="hoverimage" href="/bgstrategy/hero/?id=16">Deathwing</a> will be inactive) or any other abilities.
        <br><br>
