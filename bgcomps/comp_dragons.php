...
<div class="comp_wrapper">
    ...
    <p>
     ...
     <h3 id="persistent">End of Turn Dragons <a tabindex="0" onclick="CopyLink(this);" title="Copy the link to this section to your clipboard"><i class="bi bi-link-45deg"></i></a></h3>
    <?php
