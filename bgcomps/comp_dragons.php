...
<div class="comp_wrapper">
    ...
    <?php
    $board   = ['Warpwing', 'Kaly', 'Kaly', 'Guardian', 'Hunter', 'Brann', 'Smolderer'];
    $minions = getMinionsForBoard($board);
    drawBoard($minions);
    ?>
    <p>
