...
<div class="comp_wrapper">
    ...
    <?php
    $board   = ['Deflecto', 'Deflecto', 'Puller', 'Puller', 'Horse', 'Horse', 'Czarina'];
    ...
    <?php
    $board   = ['Deflecto', 'Scraper', 'Drone', 'Beatboxer', 'Beatboxer', 'Mk II', 'Scraper'];
    $minions = getMinionsForBoard($board);
    drawBoard($minions);
    ?>
    <p>
