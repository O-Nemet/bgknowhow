...
<div class="comp_wrapper">
    <h3 id="deflecto">Magnetic Mech <a tabindex="0" onclick="CopyLink(this);" title="Copy the link to this section to your clipboard"><i class="bi bi-link-45deg"></i></a></h3>
    <?php
    ...
    <h3 id="magnetize">Magnetic Summon Comp <a tabindex="0" onclick="CopyLink(this);" title="Copy the link to this section to your clipboard"><i class="bi bi-link-45deg"></i></a></h3>
    <?php
    $board   = ['Holoy Rover', 'Holo Rover', 'Dr. Boom's Monster', 'Dr. Boom's Monster', 'Kangor's Apprentice', 'Kangor's Apprentice', 'Titus'];
    $minions = getMinionsForBoard($board);
    drawBoard($minions);
    ?>
    <p>
    ...
    <h3 id="shield">Holy Mecherel Comp<a tabindex="0" onclick="CopyLink(this);" title="Copy the link to this section to your clipboard"><i class="bi bi-link-45deg"></i></a></h3>
    <?php
    ...
    ?>
    <p>
You're going to try your best to get Magnetic reborn cards to resummon the Automaton's. You do this by finding Mecha Jaraxxus or Prosthetic Hand. While Leroy is here to fill the rest of the build up, by being a universally strong card, Chameleon is here to be a third Kangor's. Eventually, you can replace Leroy with a third Automaton that is golden by using the spell "Eyes of the Earth Mother"    </p>
    </p>
    
    <h3 id="shield">End of Turn Mech <a tabindex="0" onclick="CopyLink(this);" title="Copy the link to this section to your clipboard"><i class="bi bi-link-45deg"></i></a></h3>
    <?php
