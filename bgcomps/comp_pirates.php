...
<div class="comp_wrapper">
    ...
    <p>
        ...
        <br><br>
        Bob's Tip Jar, Kodo Leather Pouch, Booty Bay Brew, Windrunner Necklace, Ceremonial Sword, Elementium Chest, Fancy Spelbook, Designer Eyepatch, and Balladist Portrait are all ideal trinkets.
    </p>
    ...
    <?php
    $board   = ['Fisher', 'Peggy Sturdybone', 'Peggy Sturdybone', 'Looter', 'Tethys', 'Tethys', 'Brann'];
    $minions = getMinionsForBoard($board);
    drawBoard($minions);
    ?>
    <p>
        ...
        <br><br>
        To make sure you go infinite and gain a lot of minions from Tethys, you have to buy cards that give you extra gold to spend. Cards such as <a class="hoverimage" href="/bgstrategy/minion/?id=125">Tavern Tempest</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=193">Shell Collector</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=119">Murozond</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=93">Primalfin Lookout</a>, <a class="hoverimage" href="/bgstrategy/minion/?id=429">Rodeo Performer</a>, and <a class="hoverimage" href="/bgstrategy/minion/?id=263">General Drakkasith</a>.
        <br><br>
        Essence of Dreams, Bob's Tip Jar, Kodo Leather Pouch, Booty Bay Brew, Ceremonial Sword, Elementium Chest, Fancy Spelbook, Designer Eyepatch, Goldenizer Supply, and Balladist Portrait are all ideal trinkets.
    </p>
    ...
    <p>
        ...
        <br><br>
        Staff of Scourge, Fishy Sticker, Windrunner Necklace, Ceremonial Sword, Elementium Chest, Fancy Spellbook, Goldenizer Supply, and Balladist Portrait are all ideal trinkets.
    </p>
</div>
