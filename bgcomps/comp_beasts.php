...
<div class="comp_wrapper">
    ...
    ?>
    <p>
        This composition is a test very much dependend on having at least two <strong>Slamma</strong>s since they scale multipliable. That means two basic ones would multiply the stats of a Beast summoned during combat by 2 x 2 = 4, whereas a golden would just triple their stats. This can heavily scale with other Slammas as long as you have board space (2 x 2 x 3 = 12 for a golden and a regular one). The multiplication by the Slammas is the last effect that goes into the equation, meaning the <strong>Sly Raptor</strong> will first spawn as 7/7, then the Mama Bears will add their +3/+3 buffs (10/10), followed by the Slammas (resulting in 40/40 for the example lineup shown).
        <br><br>
