...
<div class="comp_wrapper">
    ...
    ?>
    <p>
        This composition is very much dependend on having at least two <strong>Slamma</strong>s since they scale multipliable. That means two basic ones would multiply the stats of a Beast summoned during combat by 2 x 2 = 4, whereas a golden would just triple their stats. This can heavily scale with other Slammas as long as you have board space (2 x 2 x 3 = 12 for a golden and a regular one). The multiplication by the Slammas is the last effect that goes into the equation, meaning the Sly Raptors will first spawn as 7/7, then the Mama Bears will add their +3/+3 buffs (10/10), followed by the Slammas (resulting in 40/40 for the example lineup shown).
        <br><br>
    ...
    ?>
    <p>
        Give taunt to minions that aren't Octosari, <strong>Titus</strong> or Banana Slamma. Give stealth and divine shield to Titus Rivendare or Banana Slamma. Make sure you use Sprightly Scarab to give reborn to your beasts besides <strong>Hawkstrider</strong>, it's definitely important in this build. Be careful, <a class="hoverimage" href="/bgstrategy/minion/?id=372">Free-Flying Feathermane</a> could be summoned instead of the reborned <strong>Goldrinn</strong>.
    </p>
    ...
    ?>
    <p>
        Needs the availability of Quilboars. Very important to not play other Deathrattle (due to <strong>Macaw</strong>) or Taunt (due to <strong>Rylak</strong>) minions. Heavily improves by utilizing <a class="hoverimage" href="/bgstrategy/minion/?id=420">Sprightly Scarab</a> to Reborn as many Beasts as possible.
        <!--        <br><br>-->
