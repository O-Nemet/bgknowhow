...
<div class="comp_wrapper">
    ...
    ?>
    <p>
        This composition is very much dependend on having at least two different Slammas since they scale multipliable. That means two basic ones would multiply the stats of a Beast summoned during combat by 2 x 2 = 4, whereas a golden would just triple their stats. This can heavily scale with other Slammas as long as you have board space (2 x 2 x 3 = 12 for a golden and a regular one). The multiplication by the Slammas is the last effect that goes into the equation, meaning the Sly Raptors will first spawn as 7/7, then the Mama Bears will add their +4/+4 buffs (15/15), followed by the Slammas (60/60 for the example lineup shown).
        <br><br>
    ...
    <p>
        ...
        <br><br>
        Improves by the availability of Mechs, because Magnetize is the best option to profit from a heavily buffed tavern. Tricky to play, because your board will be rather weak until you triple minions. The Felementals can be replaced by <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=106">Annihilan Battlemaster</a> after your HP is low enough or by <a class="hoverimage" href="https://bgknowhow.com/bgstrategy/minion/?id=260">Mecha-Jaraxxus</a> in the late game.
    </p>
    <br>
</div>
