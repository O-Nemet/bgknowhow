...
?>
    ...
    <div class="comp_wrapper">
        ...
        <?php
        $board   = ['Murky', 'Young Murk-Eye', 'Murky', 'Young Murk-Eye', 'Primalfin Lookout', 'Wayward Grimscale', 'Brann'];
        ...
        <p>
            ...
            <br><br>
            The Bassgill is also useful for summoning <a class="hoverimage" href="/bgstrategy/minion/?id=208">Wayward Grimscale</a> or <a class="hoverimage" href="/bgstrategy/minion/?id=399">Relentless Mur'ghoul</a>. Also <strong>Titus Rivendare</strong> is very good for synergy with Operatic Belcher, Bassgill, and Scourfin.
        </p>
    </div>
