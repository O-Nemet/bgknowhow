...
<div class="streamers">
    <div>
        <a href="https://twitch.tv/rdulive" target="_blank">
            <img src="<?= PICTURE_LOCAL ?>misc/streamer_rdu.jpg" alt="RDU">
            <span>RDU</span>
        </a>
        <p>
    ...
    <div>
        <a href="https://twitch.tv/xqn_thesad" target="_blank">
            <img src="<?= PICTURE_LOCAL ?>misc/streamer_xqn.jpg" alt="XQN">
            <span>XQN</span>
        </a>
        <p>
    ...
    <div>
        <a href="https://twitch.tv/benice92" target="_blank">
            <img src="<?= PICTURE_LOCAL ?>misc/streamer_benice.jpg" alt="BeNice">
            <span>BeNice</span>
        </a>
        <p>
            Longtime German BG player, streaming in english.<br><br>
            Mainstay in the EU top50.<br><br>
            Winner of LL#1, LL#5 top48, LL#6 top48.<br>
        </p>
    </div>
    <div>
        <a href="https://twitch.tv/PockyPlays" target="_blank">
            <img src="<?= PICTURE_LOCAL ?>misc/streamer_pocky.jpg" alt="Pocky">
            <span>Pocky</span>
        </a>
        <p>
...
<div class="streamers">
    <div>
        <a href="https://www.youtube.com/playlist?list=PL3kmT1mmaRnGdkZGVJbcLfg_oGk32vk2v" target="_blank">
            <img src="<?= PICTURE_LOCAL ?>misc/youtube_kripp.jpg" alt="Kripparrian">
            <span>Kripparrian</span>
        </a>
        <p>
            Longtime skilled and very popular US HS player, featuring a variety of (medium-rank) BG videos.<br><br>
            Also famous for his Diablo and PoE content.
        </p>
    </div>
    <div>
    ...
    <div>
        <a href="https://www.youtube.com/channel/UCZeaUP1fx636UFuM9DrpGqA/videos" target="_blank">
            <img src="<?= PICTURE_LOCAL ?>misc/youtube_mewwy.jpg" alt="MewwyHS">
            <span>MewwyHS</span>
        </a>
        <p>
