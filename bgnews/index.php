...
<div class="news">
    ...
    <p>
        ...
        * Madam Goya and Sylvanas Windrunner have been temporarily removed from the Duos Hero Pool for balance reasons.
        <br><br>
        With the current BG season most likely ending in around 5 weeks (the Battle Pass is listed as available only until August 20), we can expect one balance patch aimed at Battlegrounds, which should bring these heroes back into the game.
    </p>
    <br>
    ...
    <p>
        ...
        <br><br>
        Today, this website has about 250 unique visitors a day, and according to the engagement time, most users are enjoying and utilizing the content very well. Just last week, I did receive the first-ever PayPal donation, appreciating the time and effort I've put into this site so far. I want to tell that kind stranger and everyone else who supported me on this journey that I am very grateful, and it means a lot to me. With a full-time day job and a family to provide for, I am aware that the speed of adding content is slow compared to other pages, and some technical aspects are still lacking. That is one of the reasons I try to focus on evergreen content and information.
        <br><br>
    ...
    <p>
        ...
        The meta is still fresh, so of course this is just a first pass, but should provide you with plenty ideas and directions to aim for.
        <br><br>
        From now on these compositions are brought to you by high-MMR player and <a href="https://metafy.gg/@mewwyhs" target="_blank">BG coach</a> <a href="https://twitter.com/mewwyhs" target="_blank">Mewwy</a>. Check out his <a href="https://www.youtube.com/@MewwyHS" target="_blank">YouTube channel</a> and maybe <a href="https://ko-fi.com/mewwyhs" target="_blank">buy him a coffee</a> if you liked them.
    </p>
    <br>
