...
?>
    ...
    <p class="bgjson_introduction">
        ...
        For example <em>nameShort</em> attaches the short name the community uses to reference the entity (e.g. '<a class="hoverimage" href='/bgstrategy/minion/?id=131'>Eliza</a>' instead of '<a class="hoverimage" href='/bgstrategy/minion/?id=131'>Dread Admiral Eliza</a>'), <em>pictureSmall</em> references a webp version up to ten times smaller than the original image, while <em>websites</em> includes an array of links to the entity representation on the biggest HS community hubs.
