...
<footer>
    <div style="float: left;"><img src="<?= IMG_PATH ?>icons/logo_html5_small.webp" width="62" alt="HTML5 logo" title="Produced with HTML5"></div>
    <div style="float: right;"><a href="https://playhearthstone.com/battlegrounds" target="_blank"><img src="<?= IMG_PATH ?>icons/logo_blizzard-entertainment_small.webp" width="140" alt="Blizzard Entertainment logo" title="For more information about Blizzard Entertainment or any of Blizzards' trademarks or other intellectual property, please visit their website at playhearthstone.com/battlegrounds"></a></div>
    <nav style="margin-top: 10px; margin-bottom: 10px;">
        <small>
            ...
            <span style="padding-left: 5px; padding-right: 5px; border-right: 1px solid #777777;"> <a href="//bgknowhow.com/license.php">License (MIT)</a></span>
            <span style="padding-left: 5px;"> <a href="//bgknowhow.com/imprint.php">Imprint</a></span>
        </small>
    </nav>
