...
//                        echo "<a href='" . $minion->websites->bgknowhow . "'><img src='" . PICTURE_LOCAL_MINION . $minion->id . PICTURE_LOCAL_TILE_SUFFIX . "'></a>";
    ...
    if ($show == 'anomalies' || $show == 'all') {
        ...
        <br><br>On 29.08. the three anomalies <a href="/bgstrategy/anomaly/?id=24">Little League</a>, <a href="/bgstrategy/anomaly/?id=21">Big League</a> and <a href="/bgstrategy/anomaly/?id=23">Everything\'s on Fire!</a> were added and will have a "increased" appearance rate until new anomalies will be added.</p>';
    }
