...
//                        echo "<a href='" . $minion->websites->bgknowhow . "'><img src='" . PICTURE_LOCAL_MINION . $minion->id . PICTURE_LOCAL_TILE_SUFFIX . "'></a>";
    ...
    if ($show == 'anomalies' || $show == 'all') {
        ...
        <br><br>On 10.10. the three anomalies <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=39">Reckless Enhancement</a>, <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=40">Tavern Special</a> and <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=41">Eonar\'s Overgrown Arena</a> were added and will have a "increased" appearance rate until new anomalies will be added.</p>';
    }
