...
//                        echo "<a href='" . $minion->websites->bgknowhow . "'><img src='" . PICTURE_LOCAL_MINION . $minion->id . PICTURE_LOCAL_TILE_SUFFIX . "'></a>";
    ...
    if ($show == 'anomalies' || $show == 'all') {
        ...
        <br><br>On 24.10. the three anomalies <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=49">What Are the Odds?</a>, <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=50">How to Even??</a> and <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=51">Deep Blue Sooner</a> were added and will have a "increased" appearance rate until new anomalies will be added.</p>';
    }
