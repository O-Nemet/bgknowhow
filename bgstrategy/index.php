...
//                        echo "<a href='" . $minion->websites->bgknowhow . "'><img src='" . PICTURE_LOCAL_MINION . $minion->id . PICTURE_LOCAL_TILE_SUFFIX . "'></a>";
    ...
    if ($show == 'anomalies' || $show == 'all') {
        ...
        <br><br>On 03.10. the three anomalies <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=36">Shackles of the Primus</a>, <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=37">Summoning of Champions</a> and <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=38">Curse of Aggramar</a> were added and will have a "increased" appearance rate until new anomalies will be added.</p>';
    }
