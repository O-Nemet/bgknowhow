...
//                        echo "<a href='" . $minion->websites->bgknowhow . "'><img src='" . PICTURE_LOCAL_MINION . $minion->id . PICTURE_LOCAL_TILE_SUFFIX . "'></a>";
    ...
    if ($show == 'anomalies' || $show == 'all') {
        ...
        <br><br>On 31.10. the three anomalies <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=52">Treasure Hoard</a>, <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=53">Valuation Inflation</a> and <a class=\'hoverimage\' href="/bgstrategy/anomaly/?id=54">No Place Like Holmes</a> were added and will have a "increased" appearance rate until new anomalies will be added.</p>';
    }
