...
//                        echo "<a href='" . $minion->websites->bgknowhow . "'><img src='" . PICTURE_LOCAL_MINION . $minion->id . PICTURE_LOCAL_TILE_SUFFIX . "'></a>";
    ...
    if ($show == 'anomalies' || $show == 'all') {
        ...
        echo '<p>One anomaly is randomly choosen from the pool of active anomalies before the hero selection and will apply to all players for the remainder of the whole game. The anomaly called <a href="/bgstrategy/anomaly/?id=8">Secrets of Norgannon</a> is five times as likely to be selected as any other anomalies. Which means with currently ' . $numberOfAnomalies . ' different anomalies active any anomaly would have a chance of ' . number_format(100 / $numberOfAnomalies, 2) . '% to be active, but due to this special rule \'Secrets\' has a 5/' . $numberOfAnomalies + 4 . ' or ' . number_format(5 / ($numberOfAnomalies + 4), 2) . '% chance and any other anomaly a 1/' . $numberOfAnomalies + 4 . ' or ' . number_format(1 / ($numberOfAnomalies + 4), 2) . '% chance to show up. Three new anomalies will be added to the pool every week and feature an increased appearance rate until the next release.
        ...
        <br><br>On 03.10. the three anomalies <a href="/bgstrategy/anomaly/?id=36">Shackles of the Primus</a>, <a href="/bgstrategy/anomaly/?id=37">Summoning of Champions</a> and <a href="/bgstrategy/anomaly/?id=38">Curse of Aggramar</a> were added and will have a "increased" appearance rate until new anomalies will be added.</p>';
    }
