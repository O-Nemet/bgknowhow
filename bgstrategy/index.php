...
//                        echo "<a href='" . $minion->websites->bgknowhow . "'><img src='" . PICTURE_LOCAL_MINION . $minion->id . PICTURE_LOCAL_TILE_SUFFIX . "'></a>";
    ...
    if ($show == 'anomalies' || $show == 'all') {
        ...
        <br><br>On 05.09. the three anomalies <a href="/bgstrategy/anomaly/?id=29">Wisdom of Ulduar</a>, <a href="/bgstrategy/anomaly/?id=26">Overseer\'s Orb</a> and <a href="/bgstrategy/anomaly/?id=28">Perfected Alchemy</a> were added and will have a "increased" appearance rate until new anomalies will be added.</p>';
    }
