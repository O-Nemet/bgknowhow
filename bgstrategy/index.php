...
//                        echo "<a href='" . $minion->websites->bgknowhow . "'><img src='" . PICTURE_LOCAL_MINION . $minion->id . PICTURE_LOCAL_TILE_SUFFIX . "'></a>";
    ...
    if ($show == 'anomalies' || $show == 'all') {
        ...
        <br><br>On 26.09. the three anomalies <a href="/bgstrategy/anomaly/?id=33">Match Fixing</a>, <a href="/bgstrategy/anomaly/?id=34">Up-Prizing</a> and <a href="/bgstrategy/anomaly/?id=35">Gladiator\'s Spoils</a> were added and will have a "increased" appearance rate until new anomalies will be added.</p>';
    }
