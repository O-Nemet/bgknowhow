...
//            echo "    <td>" . $minion_count['None'][$i] . "</td>";
    ...
    <div class="comp_wrapper cf">
        <?php
        $board   = ['Rat', 'Ripsnarl', 'Angler', 'Rewinder', 'Gobbler'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        unset($board);
        ?>
    ...
    <div class="comp_wrapper cf">
        <?php
        $board   = ['Snapjaw', 'Bird', 'Tusk', 'Bookie', 'Lurker', 'Riffer', 'Snail', 'Copter', 'Lulla', 'Trickster', 'Muck', 'Skyfin', 'Sandspewer', 'Refiner', 'Deathswarmer', 'Murcules', 'Duelist'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        unset($board);
        ?>
    ...
    <div class="comp_wrapper cf">
        <?php
        $board   = ['Barnstormer', 'Coldlight', 'Mug', 'Oozeling'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        unset($board);
        ?>
    ...
    <div class="comp_wrapper cf">
        ...
        unset($board);
        echo "<br>";
        $board   = ['Razorgore', 'Hunter', 'Kaly'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        unset($board);
        echo "<br>";
        $board   = ['Frostling', 'Master', 'Rock Rock'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        unset($board);
        echo "<br>";
        $board   = ['Deflecto', 'Scraper', 'Lighter', 'Beatboxer'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        unset($board);
        echo "<br>";
        ...
        unset($board);
        echo "<br>";
        $board   = ['Piper', 'Roogug', 'Charly', 'Bristlebach'];
        $minions = getMinionsForBoard($board);
        drawBoard($minions);
        unset($board);
        echo "<br>";
